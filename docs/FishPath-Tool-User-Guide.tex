...
\setlength{\droptitle}{-2em}
  ...
  \postdate{\par}
    \date{Last updated: February 11, 2020}
...
\caption{Initial results display screen in the FishPath tool (featuring the Data Collection section), displaying a snapshot of results, not a full listing.}\label{fig:results-overview}
\end{figure}
