...
```{r fishery-entry, echo=FALSE, fig.cap='Entry screen to the FishPath tool questionnaire after fishery information has been defined.', fig.align='center', out.width='95%', fig.show='hold'}
