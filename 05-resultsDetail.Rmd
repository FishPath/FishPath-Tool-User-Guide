...
```{r flagged-questions, echo=FALSE, fig.cap='List of flagged questions.', fig.align='center', out.width='95%', fig.show='hold'}
...
3.	**Critical Evaluation of Top Options (\@ref(fig:review-step-3)):** In the final step, users can more critically evaluate the top options by considering each criterion and caveat in complete detail, and, potentially, ranking the options in order of potential. To facilitate this process, users can export a report that lists the top options and all of their details. 
