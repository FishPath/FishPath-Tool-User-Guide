...
```{r results-overview, echo=FALSE, fig.cap='Initial results display screen in the FishPath tool (featuring the Data Collection section), displaying a snapshot of results, not a full listing.', fig.align='center', out.width='95%', fig.show='hold'}
knitr::include_graphics('images/results-overview.png')
```

## Results Support Tools

At the top of the Results Page, the user may either “Share”, “Export”, or “Copy” the results for their fishery (Figure \@ref(fig:results-overview)). 
